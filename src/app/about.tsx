    ...
    return (
        <div className="mb-10">
            <p className="text-sm text-stone-700 dark:text-stone-300"> 
                I&apos;m an engineer at <Link href={"https://www.nuro.ai/"} target="_blank" className="inline-flex items-center hover:bg-gray-400/30 rounded transition duration-700 ease-in-out">Nuro<LuArrowUpRight className="text-base"/></Link>, where I focus on sensor software development and hardware-software integration for ADAS and robotics platforms. My interests span a broad range of areas, including software development, embedded systems, signal processing, machine learning and applied AI for robotics, working at the intersection of software, hardware and systems. <br />
